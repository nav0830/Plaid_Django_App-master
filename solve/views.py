...
def index(request):
	...
	return render(request, 'solve/index.html', data)
...
def transactions(request):
	...
	return render(request, 'solve/transactions.html', data)

@csrf_protect
def link_account(request):
	context = {}
	return render(request, 'solve/link-account.html', context)
...
def create_link_token(request):
	...
	if user.is_authenticated:
		data = {
			...
			'client_name': "Naveen's Finance App",
			'country_codes': ['US'],
			'language': 'en'
		}
...
def signup(request):
	...
	return render(request, 'solve/signup.html',)
...
def log_in_form(request):
	return render(request, 'solve/log-in.html',)
